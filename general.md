...
- **Test the real dispatch path for dispatch bugs**: When a bug is in completion, hooks, command routing, async callbacks, or another dispatcher, include a test that drives the installed or public entry path.
